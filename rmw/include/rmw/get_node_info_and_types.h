...
/// Return all topic names, type hashes and types for which a given remote node has subscriptions.
/**
 * This function returns an array of topic names, type hashes and types for which a given remote
